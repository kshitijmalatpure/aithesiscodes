...
for fold_num in range(1, 11):
    ...
    output_path = fold_dir / f"GNB_Results_fold{fold_num}.txt"
...
summary_csv_path = base_dir / "GNB_Metrics_Summary.csv"
...
agg_csv_path = base_dir / "GNB_Metrics_Aggregated.csv"
agg_df.to_csv(agg_csv_path, index=False)

# Save all summed confusion matrices to a text file
confmat_path = base_dir / "GNB_AllFolds_SummedConfusionMatrices.txt"
