...
class FabOFV840Enhanced:
    def __init__(self, base_dir, name_col, score_cols, labels, importance_threshold=0.005, features_per_page=15):
        ...
        self.root = self.base_dir / "fabOF_results_v8.4.0_TUNED_PIPELINE_FIXED_ONLY_LAST"
        ...
        for sc_idx, sc in enumerate(self.score_cols, 1):
            ...
            for fold in range(1, 11):
                ...
                try:
                    ...
                    # NOTE: Previously the last feature was excluded here. Now we keep ALL features.
                    feats = [feats[-1]]  # USE ONLY the last feature column  # <-- ONLY CHANGE: exclude the last feature
