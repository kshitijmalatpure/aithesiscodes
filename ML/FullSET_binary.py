    ...
    def run_single_experiment(self, fold_num, model_name, feature_selection_name):
        ...
        try:
            ...
            for i, score_col in enumerate(self.score_columns):
                ...
                y_train_col, y_test_col = y_train[:, i], y_test[:, i]  # binary labels 0/1
                ...
                if feature_selection_name == 'Baseline':
                    ...
                    X_train_selected, X_test_selected, support = self.apply_lasso_feature_selection(
                        X_train_scaled, y_train_col, X_test_scaled
                    )
                ...
                X_train_resampled, y_train_resampled = resampler.fit_resample(X_train_selected, y_train_col)
...
def main():
    ...
    print(f"Check the '{pipeline.base_dir / 'comprehensive_results_binary'}' directory for all outputs.")
