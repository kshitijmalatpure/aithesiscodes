...
PROMPT_FILE = Path(r"C:\Research\AI Folder\Thesis\Data\data_CTO_Kshitij\Main\LLMs (3.0)\Prompts\TTPrompt.txt")

# The folder where all results will be saved.
RESULTS_DIR = Path(r"C:\Research\AI Folder\Thesis\Data\data_CTO_Kshitij\Main\LLMs (3.0)\A_TT\scoring_results_oss")
...
# Recommended: Load from environment. Safer than hard-coding.
# To set it, run this in your terminal: export OPENROUTER_API_KEY="sk-or-..."
API_KEY     = os.getenv("OPENROUTER_API_KEY", "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")
# ─────────────────────────────────────────────────────────────────────────────
