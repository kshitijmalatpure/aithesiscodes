...
for fold_num in range(1, 11):
    ...
    output_path = fold_dir / f"RF_Standardised_Results_fold{fold_num}.txt"
    ...
    # Clip predictions to valid score range [1, 4]
    y_pred_clipped = np.clip(y_pred, 1, 4)
...
summary_csv_path = base_dir / "RF_Standardised_Regression_Metrics_Summary.csv"
...
agg_csv_path = base_dir / "RF_Standardised_Regression_Metrics_Aggregated.csv"
agg_df.to_csv(agg_csv_path, index=False)

# Save all summed confusion matrices to a text file
confmat_path = base_dir / "RF_Standardised_AllFolds_SummedConfusionMatrices.txt"
