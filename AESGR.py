...
PROMPT_FILE = Path(r"C:\Research\AI Folder\Thesis\Data\data_CTO_Kshitij\Main\LLMs (3.0)\Prompts\GRPrompt.txt")

# The folder where all results will be saved.
RESULTS_DIR = Path(r"C:\Research\AI Folder\Thesis\Data\data_CTO_Kshitij\Main\LLMs (3.0)\A_GR\scoring_results_oss")
