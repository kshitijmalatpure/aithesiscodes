...
class ComprehensiveMLPipeline:
    ...
    def run_single_experiment(self, fold_num, model_name, feature_selection_name):
        ...
        try:
            ...
            for i, score_col in enumerate(self.score_columns):
                ...
                # --- FIX PART 1: ADJUST LABELS FOR XGBOOST BEFORE TRAINING ---
                # XGBoost requires 0-indexed labels. Other sklearn models are fine with 1-indexed.
                ...
                if feature_selection_name == 'Baseline':
                    ...
                    # Pass the adjusted labels for classification-like feature selection
                    ...
                    # Pass the adjusted labels to fit
                ...
                # SMOTE will now receive 0-indexed labels for XGBoost, as required.
                ...
                # The model is now fit with the correct label format
                model_clone.fit(X_train_resampled, y_train_resampled)
                y_pred = model_clone.predict(X_test_selected)

                # --- FIX PART 2: REVERT PREDICTIONS TO ORIGINAL SCALE FOR METRICS ---
                # If we subtracted 1 before training, we must add 1 back to the predictions.
                if model_name == 'XGBoost':
                    y_pred += 1
                # --- END OF FIX PART 2 ---

                # Now y_pred and y_test_col are both on the same scale [1, 2, 3, 4]
    ...
    def save_results(self):
        # ... (no changes needed) ...
        results_dir = self.base_dir / "comprehensive_results_smote"  # Changed folder name for clarity
    ...
    def create_visualizations(self):
        # ... (no changes needed) ...
        results_dir = self.base_dir / "comprehensive_results_smote"
...
def main():
    ...
    print(f"Check the '{pipeline.base_dir / 'comprehensive_results_smote'}' directory for all outputs.")
