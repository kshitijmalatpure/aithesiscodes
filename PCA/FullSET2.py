...
class ComprehensiveMLPipeline:
    ...
    def run_single_experiment(self, fold_num, model_name, feature_selection_name):
        ...
        try:
            ...
            # NOTE: This assumes you are using the 'tr.csv' and 'te.csv' variants.
            # If testing other variants (e.g., trb.csv), you would change these filenames.
            ...
            # --- CRITICAL FIX FOR ZERO-VARIANCE FEATURES ---
            # Replace any NaN or inf values created by the scaler (from division by zero) with 0.
            ...
            for i, score_col in enumerate(self.score_columns):
                ...
                # ... (elif blocks for PCA, LASSO, KBest) ...
                ...
                # ... (rest of your logic for feature usage, training, metrics, etc.)
                ...
                model_clone.fit(X_train_selected, y_train_col_adj)
    ...
    def save_feature_analysis(self):
        ...
        feature_analysis_dir = self.base_dir / "comprehensive_results" / "feature_analysis"
...
def main():
    ...
    print("Check the 'comprehensive_results' directory for all outputs.")
